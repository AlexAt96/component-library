...
Show completed versus total evidence requirements with accessible percentage text.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderCollectionEvidenceProgressBar(...)` | `app/src/app.js` | 8890-8910 | `code/app--renderCollectionEvidenceProgressBar.reference.js` |
| UI renderer/controller | `formatEvidenceProgressPercent(...)` | `app/src/app.js` | 8912-8916 | `code/app--formatEvidenceProgressPercent.reference.js` |
...
1. Show completed versus total evidence requirements with accessible percentage text.
...
- **Primary interaction:** Exercise the main output: Progress indicator. Show the state change immediately.
