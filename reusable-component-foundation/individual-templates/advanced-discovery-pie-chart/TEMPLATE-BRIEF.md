...
Render an advanced-discovery distribution as an SVG pie with a centre label.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderAdvancedDiscoveryPieChart(...)` | `app/src/app.js` | 13235-13275 | `code/app--renderAdvancedDiscoveryPieChart.reference.js` |
...
1. Render an advanced-discovery distribution as an SVG pie with a centre label.
...
- **Primary interaction:** Exercise the main output: SVG pie and legend. Show the state change immediately.
