# Complexity band definition table
...
Explain the governed thresholds behind size and complexity labels.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderBandDefinitionTable(...)` | `app/src/app.js` | 11010-11028 | `code/app--renderBandDefinitionTable.reference.js` |
...
1. Explain the governed thresholds behind size and complexity labels.
...
- **Primary interaction:** Exercise the main output: Reference table. Show the state change immediately.
