...
Render a captioned compact table for calculation references and report summaries.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderMiniTable(...)` | `app/src/app.js` | 16976-16978 | `code/app--renderMiniTable.reference.js` |
...
- Read-only table markup

## Behaviour to preserve

1. Render a captioned compact table for calculation references and report summaries.
...
- **Primary interaction:** Exercise the main output: Read-only table markup. Show the state change immediately.
