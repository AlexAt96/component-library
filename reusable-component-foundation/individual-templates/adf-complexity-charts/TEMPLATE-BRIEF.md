...
Visualise ADF activity counts, weighted complexity and environment distribution.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderBuAdfComplexityCharts(...)` | `app/src/app.js` | 12882-12909 | `code/app--renderBuAdfComplexityCharts.reference.js` |
| UI renderer/controller | `getAdfActivityTypeRows(...)` | `app/src/app.js` | 12864-12880 | `code/app--getAdfActivityTypeRows.reference.js` |
...
- BU
- ADF complexity model

## Outputs (events/callbacks)

- Activity and environment charts

## Behaviour to preserve

1. Visualise ADF activity counts, weighted complexity and environment distribution.
...
- **Primary interaction:** Exercise the main output: Activity and environment charts. Show the state change immediately.
