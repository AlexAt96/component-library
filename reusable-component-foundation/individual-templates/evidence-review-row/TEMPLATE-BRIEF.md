...
Show one evidence artifact, environment tags, current review status and follow-up state.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderEvidenceReviewRow(...)` | `app/src/app.js` | 10208-10250 | `code/app--renderEvidenceReviewRow.reference.js` |
| UI renderer/controller | `createEvidenceReviewArtifact(...)` | `app/src/app.js` | 10626-10642 | `code/app--createEvidenceReviewArtifact.reference.js` |
| UI renderer/controller | `normaliseEvidenceReviewState(...)` | `app/src/app.js` | 10644-10654 | `code/app--normaliseEvidenceReviewState.reference.js` |

Start with those focused extracts. Use the full source snapshot only for helpers they call.

## Inputs (props/template controls)

- Normalised review artifact
...
1. Show one evidence artifact, environment tags, current review status and follow-up state.
...
- **Primary interaction:** Exercise the main output: Open evidence. Show the state change immediately.
