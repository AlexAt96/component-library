...
Render a consistent missing, partial, submitted, reviewed or not-applicable marker.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderEvidenceStatusIcon(...)` | `app/src/app.js` | 9018-9022 | `code/app--renderEvidenceStatusIcon.reference.js` |
...
1. Render a consistent missing, partial, submitted, reviewed or not-applicable marker.
...
- **Primary interaction:** Exercise the main output: Accessible icon and label. Show the state change immediately.
