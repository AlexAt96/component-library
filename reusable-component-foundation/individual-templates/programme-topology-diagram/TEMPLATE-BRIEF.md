...
Show current or proposed environment topology across business units.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderProgramTopologyDiagram(...)` | `app/src/app.js` | 17583-17597 | `code/app--renderProgramTopologyDiagram.reference.js` |
...
1. Show current or proposed environment topology across business units.
...
- **Primary interaction:** Exercise the main output: Topology diagram. Show the state change immediately.
