...
Compose summary counts, metric cards, supporting statistics and data-contract table.
...
| --- | --- | --- | ---: | --- |
| System Map UI renderer | `renderDoraMetricsReport(...)` | `docs/reports/interactive-system-map.html` | 8102-8150 | `code/interactive-system-map--renderDoraMetricsReport.reference.html` |

Start with those focused extracts. Use the full source snapshot only for helpers they call.

## Inputs (props/template controls)

- Normalised DORA metrics
...
1. Compose summary counts, metric cards, supporting statistics and data-contract table.
...
- **Primary interaction:** Exercise the main output: DORA report view. Show the state change immediately.
...
- [dora-metric-card](../dora-metric-card/TEMPLATE-BRIEF.md)
- [dora-supporting-stat-table](../dora-supporting-stat-table/TEMPLATE-BRIEF.md)
