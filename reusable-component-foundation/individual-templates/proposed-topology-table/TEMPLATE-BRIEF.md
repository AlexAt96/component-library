...
Render editable proposed environments or topology structures with import/export column definitions.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderProposedTopologyTable(...)` | `app/src/app.js` | 20942-20973 | `code/app--renderProposedTopologyTable.reference.js` |
...
- Edited topology rows

## Behaviour to preserve

1. Render editable proposed environments or topology structures with import/export column definitions.
...
- **Primary interaction:** Exercise the main output: Edited topology rows. Show the state change immediately.
