...
Build and render the cross-pipeline touchpoint graph for datasets, activities and Databricks objects.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `buildAdfPipelineTouchpointGraph(...)` | `app/src/app.js` | 12498-12601 | `code/app--buildAdfPipelineTouchpointGraph.reference.js` |
| UI renderer/controller | `serializeAdfPipelineTouchpointGraph(...)` | `app/src/app.js` | 12603-12622 | `code/app--serializeAdfPipelineTouchpointGraph.reference.js` |
| UI renderer/controller | `renderAdfPipelineTouchpointSvg(...)` | `app/src/app.js` | 12624-12688 | `code/app--renderAdfPipelineTouchpointSvg.reference.js` |
...
1. Build and render the cross-pipeline touchpoint graph for datasets, activities and Databricks objects.
...
- **Primary interaction:** Exercise the main output: Graph nodes/edges. Show the state change immediately.
