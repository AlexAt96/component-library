...
Filter phase work by accountable role or show all owners.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderPhaseDashboardOwnerFilter(...)` | `app/src/app.js` | 3319-3337 | `code/app--renderPhaseDashboardOwnerFilter.reference.js` |
| UI renderer/controller | `getPhaseDashboardOwnerFilter(...)` | `app/src/app.js` | 3360-3367 | `code/app--getPhaseDashboardOwnerFilter.reference.js` |
...
1. Filter phase work by accountable role or show all owners.
...
- **Primary interaction:** Exercise the main output: Owner filter change. Show the state change immediately.
