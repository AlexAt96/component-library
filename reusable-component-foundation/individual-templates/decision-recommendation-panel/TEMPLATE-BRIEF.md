...
Explain the recommended action, readiness and confidence for each BU.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderDecisionCgiRecommendationPanel(...)` | `app/src/app.js` | 27071-27097 | `code/app--renderDecisionCgiRecommendationPanel.reference.js` |
| UI renderer/controller | `renderDecisionCgiRecommendationRows(...)` | `app/src/app.js` | 27099-27113 | `code/app--renderDecisionCgiRecommendationRows.reference.js` |
| UI renderer/controller | `getDecisionReadinessSignal(...)` | `app/src/app.js` | 27141-27150 | `code/app--getDecisionReadinessSignal.reference.js` |
...
1. Explain the recommended action, readiness and confidence for each BU.
...
- **Primary interaction:** Exercise the main output: Recommendation rows. Show the state change immediately.
