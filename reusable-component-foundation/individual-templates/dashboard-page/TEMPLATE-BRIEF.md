...
Compose the dashboard header, statistics tab, planning tab and phase/work queues.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderDashboard(...)` | `app/src/app.js` | 1786-1809 | `code/app--renderDashboard.reference.js` |
...
1. Compose the dashboard header, statistics tab, planning tab and phase/work queues.
...
- **Primary interaction:** Exercise the main output: Tab selection. Show the state change immediately.
...
- [dashboard-tab-bar](../dashboard-tab-bar/TEMPLATE-BRIEF.md)
- [dashboard-kpi-card](../dashboard-kpi-card/TEMPLATE-BRIEF.md)
- [dashboard-line-chart](../dashboard-line-chart/TEMPLATE-BRIEF.md)
- [project-plan-gantt](../project-plan-gantt/TEMPLATE-BRIEF.md)
