# Proposed topology flow diagram
...
Visualise how proposed environments relate in the target estate.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderProposedTopologyFlowDiagram(...)` | `app/src/app.js` | 21000-21285 | `code/app--renderProposedTopologyFlowDiagram.reference.js` |
| UI renderer/controller | `renderEnvironmentMigrationFlowDiagram(...)` | `app/src/app.js` | 21287-21491 | `code/app--renderEnvironmentMigrationFlowDiagram.reference.js` |

Start with those focused extracts. Use the full source snapshot only for helpers they call.

## Inputs (props/template controls)

- Current rationalisation rows
- Proposed environments

## Outputs (events/callbacks)

- Migration/topology SVG

## Behaviour to preserve

1. Visualise how proposed environments relate in the target estate.
...
- **Primary interaction:** Exercise the main output: Migration/topology SVG. Show the state change immediately.
