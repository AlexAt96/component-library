...
Render a compact SVG trend line with labelled points and an empty state.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderDiscoveryLineChart(...)` | `app/src/app.js` | 1929-1980 | `code/app--renderDiscoveryLineChart.reference.js` |
...
1. Render a compact SVG trend line with labelled points and an empty state.
...
- **Primary interaction:** Exercise the main output: Accessible SVG chart. Show the state change immediately.
...
- [chart-empty-state](../chart-empty-state/TEMPLATE-BRIEF.md)
