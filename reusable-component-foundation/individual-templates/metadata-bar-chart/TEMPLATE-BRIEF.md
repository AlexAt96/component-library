...
Show the leading metadata categories as proportional horizontal bars.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderMetadataBarChart(...)` | `app/src/app.js` | 14231-14255 | `code/app--renderMetadataBarChart.reference.js` |
...
1. Show the leading metadata categories as proportional horizontal bars.
...
- **Primary interaction:** Exercise the main output: Metadata distribution chart. Show the state change immediately.
