...
Display the controlled status model and its ordering/meaning.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderPhaseStatusModelTable(...)` | `app/src/app.js` | 7994-8016 | `code/app--renderPhaseStatusModelTable.reference.js` |
...
1. Display the controlled status model and its ordering/meaning.
...
- **Primary interaction:** Exercise the main output: Status reference display. Show the state change immediately.
...
- `PUT /api/programme/status-reference`
