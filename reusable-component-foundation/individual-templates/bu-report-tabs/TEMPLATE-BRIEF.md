...
Switch between report document, source/review and client-readable states.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderBuTechReportTabs(...)` | `app/src/app.js` | 24780-24795 | `code/app--renderBuTechReportTabs.reference.js` |
| UI renderer/controller | `getBuTechReportTabHref(...)` | `app/src/app.js` | 24770-24778 | `code/app--getBuTechReportTabHref.reference.js` |
...
1. Switch between report document, source/review and client-readable states.
...
- **Primary interaction:** Exercise the main output: Tab navigation. Show the state change immediately.
