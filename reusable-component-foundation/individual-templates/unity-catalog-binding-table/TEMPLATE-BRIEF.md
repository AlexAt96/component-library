...
Render catalog/workspace bindings with status and ownership context.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderUnityCatalogBindingTable(...)` | `app/src/app.js` | 14299-14327 | `code/app--renderUnityCatalogBindingTable.reference.js` |
| UI renderer/controller | `renderUnityCatalogBindingStatus(...)` | `app/src/app.js` | 14604-14613 | `code/app--renderUnityCatalogBindingStatus.reference.js` |
...
1. Render catalog/workspace bindings with status and ownership context.
...
- **Primary interaction:** Exercise the main output: Binding status table. Show the state change immediately.
