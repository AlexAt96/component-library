...
Summarise sizing, complexity, RICE and open-decision evidence near the report editor.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderBuTechReportSummaryTable(...)` | `app/src/app.js` | 23221-23262 | `code/app--renderBuTechReportSummaryTable.reference.js` |
| UI renderer/controller | `renderBuTechReportEvidenceLinks(...)` | `app/src/app.js` | 23397-23408 | `code/app--renderBuTechReportEvidenceLinks.reference.js` |
...
1. Summarise sizing, complexity, RICE and open-decision evidence near the report editor.
...
- **Primary interaction:** Exercise the main output: Summary table. Show the state change immediately.
