# Advanced-discovery distribution chart

Parent capability: Graphs and chart primitives
Template type: primitive

## Build this exact template

Render ranked metadata or ADF distributions for the advanced-discovery screen.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderAdvancedDiscoveryDistributionChart(...)` | `app/src/app.js` | 13277-13306 | `code/app--renderAdvancedDiscoveryDistributionChart.reference.js` |
| UI renderer/controller | `getAdvancedDiscoveryChartRows(...)` | `app/src/app.js` | 13319-13333 | `code/app--getAdvancedDiscoveryChartRows.reference.js` |
...
- Normalised distribution chart

## Behaviour to preserve

1. Render ranked metadata or ADF distributions for the advanced-discovery screen.
...
- **Primary interaction:** Exercise the main output: Normalised distribution chart. Show the state change immediately.
