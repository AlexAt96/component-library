...
Summarise savings, migration cost, net benefit and BU economics.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderDecisionAccountingOverview(...)` | `app/src/app.js` | 27750-27778 | `code/app--renderDecisionAccountingOverview.reference.js` |
| UI renderer/controller | `renderDecisionAccountingBars(...)` | `app/src/app.js` | 27780-27786 | `code/app--renderDecisionAccountingBars.reference.js` |
| UI renderer/controller | `renderDecisionSavingsSummaryTable(...)` | `app/src/app.js` | 27829-27842 | `code/app--renderDecisionSavingsSummaryTable.reference.js` |
...
1. Summarise savings, migration cost, net benefit and BU economics.
...
- **Primary interaction:** Exercise the main output: Accounting bars. Show the state change immediately.
