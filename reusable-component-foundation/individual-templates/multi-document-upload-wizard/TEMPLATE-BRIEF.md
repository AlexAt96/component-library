...
Upload multiple document types against selected environments with consistent review and validation.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderMultiDocumentUploadWizard(...)` | `app/src/app.js` | 9761-9811 | `code/app--renderMultiDocumentUploadWizard.reference.js` |
| UI renderer/controller | `renderTerraformExporterWizard(...)` | `app/src/app.js` | 9419-9514 | `code/app--renderTerraformExporterWizard.reference.js` |
...
- Tagged attachment payload

## Behaviour to preserve

1. Upload multiple document types against selected environments with consistent review and validation.
...
- **Primary interaction:** Exercise the main output: Tagged attachment payload. Show the state change immediately.
