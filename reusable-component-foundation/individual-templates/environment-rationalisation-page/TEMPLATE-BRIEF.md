# Environment rationalisation page
...
Compose rationalisation inputs, proposed topology and live diagrams for one BU.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderEnvironmentRationalisation(...)` | `app/src/app.js` | 20781-20869 | `code/app--renderEnvironmentRationalisation.reference.js` |
| UI renderer/controller | `getEnvironmentRationalisationModel(...)` | `app/src/app.js` | 21918-21965 | `code/app--getEnvironmentRationalisationModel.reference.js` |
...
- Rationalisation save payload
- Import/export events

## Behaviour to preserve

1. Compose rationalisation inputs, proposed topology and live diagrams for one BU.
...
- **Primary interaction:** Exercise the main output: Rationalisation save payload. Show the state change immediately.
...
- `PUT /api/business-units/:businessUnitId/environment-rationalisation`

## Dependencies

- [proposed-topology-table](../proposed-topology-table/TEMPLATE-BRIEF.md)
- [topology-flow-diagram](../topology-flow-diagram/TEMPLATE-BRIEF.md)
- [topology-structure-diagram](../topology-structure-diagram/TEMPLATE-BRIEF.md)
- [rationalisation-import-controller](../rationalisation-import-controller/TEMPLATE-BRIEF.md)
