...
Parent capability: Editable and read-only data tables
Template type: composite

## Build this exact template

Download a table template, upload completed rows and return parsed rows for review before save.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderExcelImportExportComponent(...)` | `app/src/app.js` | 6035-6057 | `code/app--renderExcelImportExportComponent.reference.js` |
| UI renderer/controller | `wireExcelImportExportComponent(...)` | `app/src/app.js` | 35077-35103 | `code/app--wireExcelImportExportComponent.reference.js` |
| UI renderer/controller | `parseImportTableRowsFromFile(...)` | `app/src/app.js` | 40577-40585 | `code/app--parseImportTableRowsFromFile.reference.js` |
...
1. Download a table template, upload completed rows and return parsed rows for review before save.
...
- **Primary interaction:** Exercise the main output: Parsed rows. Show the state change immediately.
