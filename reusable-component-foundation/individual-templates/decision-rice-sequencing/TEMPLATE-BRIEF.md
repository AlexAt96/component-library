...
Rank BUs by RICE contribution and explain the proposed sequence.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderDecisionRiceSequencingPanel(...)` | `app/src/app.js` | 27596-27616 | `code/app--renderDecisionRiceSequencingPanel.reference.js` |
| UI renderer/controller | `renderDecisionRiceRows(...)` | `app/src/app.js` | 27618-27628 | `code/app--renderDecisionRiceRows.reference.js` |
| UI renderer/controller | `renderDecisionRiceRow(...)` | `app/src/app.js` | 27638-27652 | `code/app--renderDecisionRiceRow.reference.js` |
...
1. Rank BUs by RICE contribution and explain the proposed sequence.
...
- **Primary interaction:** Exercise the main output: Sequenced BU rows. Show the state change immediately.
