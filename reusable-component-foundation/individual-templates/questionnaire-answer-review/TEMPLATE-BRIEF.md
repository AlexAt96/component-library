...
Show saved questionnaire answers read-only and allow an authorised user to reopen the wizard at a chosen step.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderQuestionnaireAnswersModal(...)` | `app/src/app.js` | 10119-10142 | `code/app--renderQuestionnaireAnswersModal.reference.js` |
| UI renderer/controller | `renderQuestionnaireAnswersView(...)` | `app/src/app.js` | 39322-39349 | `code/app--renderQuestionnaireAnswersView.reference.js` |
| UI renderer/controller | `launchQuestionnaireEditorFromModal(...)` | `app/src/app.js` | 39253-39265 | `code/app--launchQuestionnaireEditorFromModal.reference.js` |
...
1. Show saved questionnaire answers read-only and allow an authorised user to reopen the wizard at a chosen step.
...
- **Primary interaction:** Exercise the main output: Close. Show the state change immediately.
