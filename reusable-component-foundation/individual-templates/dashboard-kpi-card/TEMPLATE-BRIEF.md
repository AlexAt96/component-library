...
Show one headline metric with detail, tone, icon, tooltip and optional navigation link.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderDiscoveryKpiCard(...)` | `app/src/app.js` | 1894-1903 | `code/app--renderDiscoveryKpiCard.reference.js` |
...
- Optional navigation event

## Behaviour to preserve

1. Show one headline metric with detail, tone, icon, tooltip and optional navigation link.
...
- **Primary interaction:** Exercise the main output: Optional navigation event. Show the state change immediately.
