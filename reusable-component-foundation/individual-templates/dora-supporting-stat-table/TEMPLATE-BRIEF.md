...
Show the evidence and supporting counts behind one DORA metric.
...
| --- | --- | --- | ---: | --- |
| System Map UI renderer | `renderDoraStatTable(...)` | `docs/reports/interactive-system-map.html` | 8208-8218 | `code/interactive-system-map--renderDoraStatTable.reference.html` |
| System Map UI renderer | `doraMissingDataSummary(...)` | `docs/reports/interactive-system-map.html` | 8288-8296 | `code/interactive-system-map--doraMissingDataSummary.reference.html` |
...
1. Show the evidence and supporting counts behind one DORA metric.
...
- **Primary interaction:** Exercise the main output: Supporting statistics. Show the state change immediately.
