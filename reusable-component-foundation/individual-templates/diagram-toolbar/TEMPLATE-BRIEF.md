...
Provide zoom, reset, refresh and export actions around an SVG or HTML diagram.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `wireSourceConsumerDiagramActions(...)` | `app/src/app.js` | 15901-16072 | `code/app--wireSourceConsumerDiagramActions.reference.js` |
...
- Zoom/reset/export events

## Behaviour to preserve

1. Provide zoom, reset, refresh and export actions around an SVG or HTML diagram.
...
- **Primary interaction:** Exercise the main output: Zoom/reset/export events. Show the state change immediately.
