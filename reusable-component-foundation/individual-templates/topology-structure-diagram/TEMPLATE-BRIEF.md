# Proposed topology structure diagram
...
Visualise account, environment and workspace structure for the target topology.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderProposedTopologyStructureDiagram(...)` | `app/src/app.js` | 21537-21891 | `code/app--renderProposedTopologyStructureDiagram.reference.js` |
...
1. Visualise account, environment and workspace structure for the target topology.
...
- **Primary interaction:** Exercise the main output: Structure diagram. Show the state change immediately.
