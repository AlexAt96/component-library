...
Switch the same phase work between Kanban and list presentation while preserving user preference.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderPhaseDashboardViewToggle(...)` | `app/src/app.js` | 3310-3317 | `code/app--renderPhaseDashboardViewToggle.reference.js` |
| UI renderer/controller | `setPhaseDashboardView(...)` | `app/src/app.js` | 3953-3970 | `code/app--setPhaseDashboardView.reference.js` |
...
1. Switch the same phase work between Kanban and list presentation while preserving user preference.
...
- **Primary interaction:** Exercise the main output: View change event. Show the state change immediately.
