# Environment evidence task list
...
List each environment's required collection tasks and direct links to complete them.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderEnvironmentTaskList(...)` | `app/src/app.js` | 9024-9033 | `code/app--renderEnvironmentTaskList.reference.js` |
...
1. List each environment's required collection tasks and direct links to complete them.
