...
Render an SVG pie chart, centre total and colour-keyed legend from label/value rows.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderReportPieVisual(...)` | `app/src/app.js` | 7114-7159 | `code/app--renderReportPieVisual.reference.js` |
| UI renderer/controller | `renderReportPieSlice(...)` | `app/src/app.js` | 7161-7168 | `code/app--renderReportPieSlice.reference.js` |
...
- Accessible SVG and legend

## Behaviour to preserve

1. Render an SVG pie chart, centre total and colour-keyed legend from label/value rows.
...
- **Primary interaction:** Exercise the main output: Accessible SVG and legend. Show the state change immediately.
