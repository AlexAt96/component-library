...
Edit the labels, definitions and scoring guidance for RICE measures.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderRiceDefinitionsEditTable(...)` | `app/src/app.js` | 7917-7935 | `code/app--renderRiceDefinitionsEditTable.reference.js` |

Start with those focused extracts. Use the full source snapshot only for helpers they call.

## Inputs (props/template controls)

- RICE metric definitions

## Outputs (events/callbacks)

- Edited RICE definitions

## Behaviour to preserve

1. Edit the labels, definitions and scoring guidance for RICE measures.
...
- **Primary interaction:** Exercise the main output: Edited RICE definitions. Show the state change immediately.
...
- `PUT /api/programme/rice-definitions`
