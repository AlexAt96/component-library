...
Show unresolved BU output feedback above a completed/read-only report and offer review/resolve actions.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderBuOutputDocumentFeedbackBanner(...)` | `app/src/app.js` | 24369-24398 | `code/app--renderBuOutputDocumentFeedbackBanner.reference.js` |
| UI renderer/controller | `wireBuOutputFeedbackDoneActions(...)` | `app/src/app.js` | 32573-32583 | `code/app--wireBuOutputFeedbackDoneActions.reference.js` |
...
1. Show unresolved BU output feedback above a completed/read-only report and offer review/resolve actions.
...
- **Primary interaction:** Exercise the main output: Open feedback dialog. Show the state change immediately.
