...
Render the completed report with all calculated tables, diagrams, sections and feedback state.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderBuTechReport(...)` | `app/src/app.js` | 24728-24762 | `code/app--renderBuTechReport.reference.js` |
| UI renderer/controller | `renderBuTechReportClientReport(...)` | `app/src/app.js` | 26707-26745 | `code/app--renderBuTechReportClientReport.reference.js` |
| UI renderer/controller | `renderBuTechReportClientSection(...)` | `app/src/app.js` | 26747-26758 | `code/app--renderBuTechReportClientSection.reference.js` |
...
1. Render the completed report with all calculated tables, diagrams, sections and feedback state.
...
- **Primary interaction:** Exercise the main output: Export action. Show the state change immediately.
...
- [bu-report-tabs](../bu-report-tabs/TEMPLATE-BRIEF.md)
