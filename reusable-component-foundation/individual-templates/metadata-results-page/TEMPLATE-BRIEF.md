# Metadata results page

Parent capability: Metadata results and advanced discovery
Template type: screen

## Build this exact template

Compose metadata statistics, category summaries, inventory tables and advanced-discovery navigation.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderMetadataReview(...)` | `app/src/app.js` | 13006-13059 | `code/app--renderMetadataReview.reference.js` |
| UI renderer/controller | `getMetadataReviewModel(...)` | `app/src/app.js` | 14018-14034 | `code/app--getMetadataReviewModel.reference.js` |
| UI renderer/controller | `getMetadataReviewSummary(...)` | `app/src/app.js` | 14036-14068 | `code/app--getMetadataReviewSummary.reference.js` |

Start with those focused extracts. Use the full source snapshot only for helpers they call.

## Inputs (props/template controls)

- BU or cross-BU context
...
- Category expansion
- Filter/export/navigation events

## Behaviour to preserve

1. Compose metadata statistics, category summaries, inventory tables and advanced-discovery navigation.
...
- **Primary interaction:** Exercise the main output: Category expansion. Show the state change immediately.
...
- [metadata-summary-cards](../metadata-summary-cards/TEMPLATE-BRIEF.md)
- [metadata-category-overview](../metadata-category-overview/TEMPLATE-BRIEF.md)
- [inventory-resource-table](../inventory-resource-table/TEMPLATE-BRIEF.md)
- [unity-catalog-binding-table](../unity-catalog-binding-table/TEMPLATE-BRIEF.md)
