...
Show source inputs, evidence links, completeness and downstream uses.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderInputTraceabilityTable(...)` | `app/src/app.js` | 5319-5348 | `code/app--renderInputTraceabilityTable.reference.js` |

Start with those focused extracts. Use the full source snapshot only for helpers they call.

## Inputs (props/template controls)

- Input register entries

## Outputs (events/callbacks)

- Evidence navigation
- Downstream-output navigation

## Behaviour to preserve

1. Show source inputs, evidence links, completeness and downstream uses.
...
- **Primary interaction:** Exercise the main output: Evidence navigation. Show the state change immediately.
