...
Show pipeline touchpoints across datasets, activities and Databricks assets.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderAdfLineageTouchpointMap(...)` | `app/src/app.js` | 12419-12496 | `code/app--renderAdfLineageTouchpointMap.reference.js` |
...
1. Show pipeline touchpoints across datasets, activities and Databricks assets.
...
- **Primary interaction:** Exercise the main output: Touchpoint graph. Show the state change immediately.
