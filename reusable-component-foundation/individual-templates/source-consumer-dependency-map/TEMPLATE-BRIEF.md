# Source/consumer dependency map
...
Turn source/consumer tracker rows into an interactive dependency diagram.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderSourceConsumerDependencyDiagram(...)` | `app/src/app.js` | 15235-15255 | `code/app--renderSourceConsumerDependencyDiagram.reference.js` |
| UI renderer/controller | `renderSourceConsumerDependencyDiagramContent(...)` | `app/src/app.js` | 15302-15313 | `code/app--renderSourceConsumerDependencyDiagramContent.reference.js` |

Start with those focused extracts. Use the full source snapshot only for helpers they call.

## Inputs (props/template controls)

- Source/consumer rows
- BU context
...
1. Turn source/consumer tracker rows into an interactive dependency diagram.
...
- **Primary interaction:** Exercise the main output: Dependency graph. Show the state change immediately.
