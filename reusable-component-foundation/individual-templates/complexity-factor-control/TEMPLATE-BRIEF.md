...
Select a governed complexity response and show its score/evidence note.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderBuComplexityFactorControl(...)` | `app/src/app.js` | 11030-11044 | `code/app--renderBuComplexityFactorControl.reference.js` |
| UI renderer/controller | `getComplexityFactorScore(...)` | `app/src/app.js` | 11089-11091 | `code/app--getComplexityFactorScore.reference.js` |
...
- Derived factor score

## Behaviour to preserve

1. Select a governed complexity response and show its score/evidence note.
...
- **Primary interaction:** Exercise the main output: Selected factor value. Show the state change immediately.
