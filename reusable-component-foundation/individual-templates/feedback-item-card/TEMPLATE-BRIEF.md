...
Render one feedback request with source, author, status and destination task link.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderFeedbackSection(...)` | `app/src/app.js` | 4262-4278 | `code/app--renderFeedbackSection.reference.js` |
| UI renderer/controller | `renderFeedbackItem(...)` | `app/src/app.js` | 4280-4300 | `code/app--renderFeedbackItem.reference.js` |
...
- Open source/task event

## Behaviour to preserve

1. Render one feedback request with source, author, status and destination task link.
...
- **Primary interaction:** Exercise the main output: Open source/task event. Show the state change immediately.
