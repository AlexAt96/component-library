# Numeric/calculated complexity control
...
Display or edit numeric complexity measures alongside their derived scores and explanations.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderBuNumericComplexityControl(...)` | `app/src/app.js` | 11046-11057 | `code/app--renderBuNumericComplexityControl.reference.js` |
| UI renderer/controller | `renderBuCalculatedComplexityControl(...)` | `app/src/app.js` | 11059-11071 | `code/app--renderBuCalculatedComplexityControl.reference.js` |
| UI renderer/controller | `calculateBuSizeBand(...)` | `app/src/app.js` | 11073-11079 | `code/app--calculateBuSizeBand.reference.js` |
| UI renderer/controller | `calculateBuComplexityBand(...)` | `app/src/app.js` | 11081-11083 | `code/app--calculateBuComplexityBand.reference.js` |
...
1. Display or edit numeric complexity measures alongside their derived scores and explanations.
...
- **Primary interaction:** Exercise the main output: Updated numeric value. Show the state change immediately.
