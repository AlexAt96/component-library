...
Compose recommendation, scenario, charts, sequencing, accounting, options and artifact sections.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderDecisionPage(...)` | `app/src/app.js` | 4407-4438 | `code/app--renderDecisionPage.reference.js` |
...
1. Compose recommendation, scenario, charts, sequencing, accounting, options and artifact sections.
...
- **Primary interaction:** Exercise the main output: Scenario changes. Show the state change immediately.
...
- [decision-recommendation-panel](../decision-recommendation-panel/TEMPLATE-BRIEF.md)
- [decision-scenario-configurator](../decision-scenario-configurator/TEMPLATE-BRIEF.md)
- [decision-savings-chart](../decision-savings-chart/TEMPLATE-BRIEF.md)
- [decision-waterfall-chart](../decision-waterfall-chart/TEMPLATE-BRIEF.md)
- [decision-rice-sequencing](../decision-rice-sequencing/TEMPLATE-BRIEF.md)
- [decision-accounting-overview](../decision-accounting-overview/TEMPLATE-BRIEF.md)
- [decision-artifact-hub](../decision-artifact-hub/TEMPLATE-BRIEF.md)
