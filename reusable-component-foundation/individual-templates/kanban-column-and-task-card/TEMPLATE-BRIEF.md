...
Render one status column and its linked task cards with owner/status context.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderContributorKanbanColumn(...)` | `app/src/app.js` | 3984-3997 | `code/app--renderContributorKanbanColumn.reference.js` |
| UI renderer/controller | `getSectionKanbanStatus(...)` | `app/src/app.js` | 3999-4007 | `code/app--getSectionKanbanStatus.reference.js` |
| UI renderer/controller | `renderSectionLink(...)` | `app/src/app.js` | 28281-28371 | `code/app--renderSectionLink.reference.js` |
| UI renderer/controller | `moveKanbanCardToStatusColumn(...)` | `app/src/app.js` | 35309-35321 | `code/app--moveKanbanCardToStatusColumn.reference.js` |
...
- Task navigation
- Optional status move

## Behaviour to preserve

1. Render one status column and its linked task cards with owner/status context.
...
- **Primary interaction:** Exercise the main output: Task navigation. Show the state change immediately.
