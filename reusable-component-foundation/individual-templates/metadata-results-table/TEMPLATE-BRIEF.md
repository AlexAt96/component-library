...
Render metadata/report rows with a caption, context and stable empty state.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderMetadataTableSection(...)` | `app/src/app.js` | 14589-14602 | `code/app--renderMetadataTableSection.reference.js` |
| UI renderer/controller | `renderDataDictionaryTableSection(...)` | `app/src/app.js` | 6918-6931 | `code/app--renderDataDictionaryTableSection.reference.js` |
...
1. Render metadata/report rows with a caption, context and stable empty state.
...
- **Primary interaction:** Exercise the main output: Read-only metadata table. Show the state change immediately.
