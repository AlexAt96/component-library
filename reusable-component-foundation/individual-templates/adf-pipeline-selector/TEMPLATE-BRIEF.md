...
Choose one pipeline flow while retaining the current explorer view.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderAdfPipelineSelector(...)` | `app/src/app.js` | 12086-12101 | `code/app--renderAdfPipelineSelector.reference.js` |
| UI renderer/controller | `getSelectedAdfPipelineFlow(...)` | `app/src/app.js` | 12081-12084 | `code/app--getSelectedAdfPipelineFlow.reference.js` |
...
1. Choose one pipeline flow while retaining the current explorer view.
...
- **Primary interaction:** Exercise the main output: Pipeline selection. Show the state change immediately.
