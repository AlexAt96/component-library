...
Group Databricks inventory resources by type and reveal captured attributes.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderDatabricksInventoryResourceTable(...)` | `app/src/app.js` | 14329-14362 | `code/app--renderDatabricksInventoryResourceTable.reference.js` |
| UI renderer/controller | `renderDatabricksInventoryResourceTypePanel(...)` | `app/src/app.js` | 14375-14394 | `code/app--renderDatabricksInventoryResourceTypePanel.reference.js` |
| UI renderer/controller | `renderMetadataAttributeDetails(...)` | `app/src/app.js` | 13989-14005 | `code/app--renderMetadataAttributeDetails.reference.js` |

Start with those focused extracts. Use the full source snapshot only for helpers they call.

## Inputs (props/template controls)

- Inventory resource rows
- Context label
- BU
...
1. Group Databricks inventory resources by type and reveal captured attributes.
...
- **Primary interaction:** Exercise the main output: Grouped resource panels. Show the state change immediately.
