# Technology-mapping metadata table
...
Edit source-to-target technology mappings, priorities and rationale.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderTechnologyMappingMetadataTable(...)` | `app/src/app.js` | 8046-8065 | `code/app--renderTechnologyMappingMetadataTable.reference.js` |
| UI renderer/controller | `renderTechnologyMappingPriorityTable(...)` | `app/src/app.js` | 8067-8077 | `code/app--renderTechnologyMappingPriorityTable.reference.js` |
| UI renderer/controller | `renderTechnologyMappingMetadataEditCells(...)` | `app/src/app.js` | 8113-8136 | `code/app--renderTechnologyMappingMetadataEditCells.reference.js` |

Start with those focused extracts. Use the full source snapshot only for helpers they call.

## Inputs (props/template controls)

- Technology mapping rows
- Priority options
...
1. Edit source-to-target technology mappings, priorities and rationale.
...
- **Primary interaction:** Exercise the main output: Edited mapping rows. Show the state change immediately.
...
- `PUT /api/programme/technology-mappings`
