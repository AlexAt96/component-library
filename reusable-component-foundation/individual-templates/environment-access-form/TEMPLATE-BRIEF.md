# Environment access confirmation form
...
Let a BU confirm Databricks and Azure access per environment and save collection status.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderEnvironmentAccessTask(...)` | `app/src/app.js` | 9077-9121 | `code/app--renderEnvironmentAccessTask.reference.js` |
| UI renderer/controller | `getEnvironmentAccessConfirmationForRow(...)` | `app/src/app.js` | 8427-8441 | `code/app--getEnvironmentAccessConfirmationForRow.reference.js` |
| UI renderer/controller | `getEnvironmentAccessPayload(...)` | `app/src/app.js` | 40217-40228 | `code/app--getEnvironmentAccessPayload.reference.js` |
...
- BU
- Environment/workspace rows
- Saved confirmations

## Outputs (events/callbacks)

- Access confirmation payload
- Save/submit event

## Behaviour to preserve

1. Let a BU confirm Databricks and Azure access per environment and save collection status.
...
- **Primary interaction:** Exercise the main output: Access confirmation payload. Show the state change immediately.
...
- `PUT /api/business-units/:businessUnitId/environment-access`
