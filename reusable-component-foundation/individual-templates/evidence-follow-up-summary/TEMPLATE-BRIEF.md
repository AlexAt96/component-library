...
Show the question, BU answer and current follow-up disposition outside the modal.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderEvidenceReviewFollowUpSummary(...)` | `app/src/app.js` | 10252-10261 | `code/app--renderEvidenceReviewFollowUpSummary.reference.js` |
| UI renderer/controller | `renderEvidenceReviewBuAnswer(...)` | `app/src/app.js` | 10263-10282 | `code/app--renderEvidenceReviewBuAnswer.reference.js` |

Start with those focused extracts. Use the full source snapshot only for helpers they call.

## Inputs (props/template controls)

- Review follow-up fields

## Outputs (events/callbacks)

- Follow-up summary markup

## Behaviour to preserve

1. Show the question, BU answer and current follow-up disposition outside the modal.
...
- **Primary interaction:** Exercise the main output: Follow-up summary markup. Show the state change immediately.
