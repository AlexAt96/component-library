...
Combine category statistics and a distribution chart inside an expandable overview.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderMetadataSectionOverview(...)` | `app/src/app.js` | 14214-14229 | `code/app--renderMetadataSectionOverview.reference.js` |
| UI renderer/controller | `renderMetadataReviewDisclosure(...)` | `app/src/app.js` | 14281-14297 | `code/app--renderMetadataReviewDisclosure.reference.js` |
...
- Expanded/collapsed category

## Behaviour to preserve

1. Combine category statistics and a distribution chart inside an expandable overview.
...
- **Primary interaction:** Exercise the main output: Expanded/collapsed category. Show the state change immediately.
...
- [metadata-bar-chart](../metadata-bar-chart/TEMPLATE-BRIEF.md)
