...
Render ranked horizontal bars with values and an explicit empty state.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderReportBarVisual(...)` | `app/src/app.js` | 7170-7205 | `code/app--renderReportBarVisual.reference.js` |
...
- Accessible bar-chart markup

## Behaviour to preserve

1. Render ranked horizontal bars with values and an explicit empty state.
...
- **Primary interaction:** Exercise the main output: Accessible bar-chart markup. Show the state change immediately.
