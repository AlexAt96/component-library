...
Compose coverage summary, suite cards, coverage table, cadence, recent log and gaps.
...
| --- | --- | --- | ---: | --- |
| System Map UI renderer | `testTelemetryMetrics(...)` | `docs/reports/interactive-system-map.html` | 7664-7666 | `code/interactive-system-map--testTelemetryMetrics.reference.html` |
| System Map UI renderer | `renderTestTelemetryReport(...)` | `docs/reports/interactive-system-map.html` | 7730-7788 | `code/interactive-system-map--renderTestTelemetryReport.reference.html` |
...
- Test coverage report view

## Behaviour to preserve

1. Compose coverage summary, suite cards, coverage table, cadence, recent log and gaps.
...
- **Primary interaction:** Exercise the main output: Test coverage report view. Show the state change immediately.
...
- [test-coverage-map](../test-coverage-map/TEMPLATE-BRIEF.md)
