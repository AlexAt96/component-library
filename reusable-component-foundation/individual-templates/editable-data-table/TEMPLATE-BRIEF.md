...
Render addable, copyable and removable form rows with screen-supplied columns and cells.
...
| --- | --- | --- | ---: | --- |
| UI renderer/controller | `renderEditDataTable(...)` | `app/src/app.js` | 6013-6033 | `code/app--renderEditDataTable.reference.js` |
| UI renderer/controller | `copyEditableTableRow(...)` | `app/src/app.js` | 40080-40099 | `code/app--copyEditableTableRow.reference.js` |
...
- Table id
- Column definitions
- Rendered editable cells
- Add label
- Row class

## Outputs (events/callbacks)

- Add/copy/remove/edit events
- Current row values

## Behaviour to preserve

1. Render addable, copyable and removable form rows with screen-supplied columns and cells.
...
- **Primary interaction:** Exercise the main output: Add/copy/remove/edit events. Show the state change immediately.
